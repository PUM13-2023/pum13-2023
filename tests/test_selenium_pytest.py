...
class TestSeleniumPytest():
    ...
    def test_play_youtube_video(self, browser_driver):
        ...
        search_bar: WebElement = browser_driver.find_elements(
        ...
        skip_add_button: WebElement = browser_driver.find_elements(By.XPATH,
        ...
        sleep(1)
        video_player: WebElement = browser_driver.find_elements(By.XPATH,
