...
class TestGenerateNavbarItems:
    ...
    def test_item_exist(self) -> None:
        """
        Test that a list is generated when a correct item to highlight exists
        """
    ...
    def test_correct_number_items(self) -> None:
        """
        Test that the generated list has the same amount of items to the original navbar list
        """
        navbar_list = generate_navbar_items(ITEM_EXIST)
    ...
    def test_no_highlighted_exist(self) -> None:
        """
        Test that it is possible to generate a list without any highlighted items
        """
    ...
    def test_highlighted_exist(self) -> None:
        """
        Test that it is possible to generate a list with a highlighted item
        """
        navbar_list = generate_navbar_items(ITEM_EXIST)
        found_class = False
        for item in navbar_list:
