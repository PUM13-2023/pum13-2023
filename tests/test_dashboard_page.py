...
@pytest.mark.test_dashboard_page
class TestDashboardPage:
    ...
    def test_carousel(self, browser_driver: webdriver) -> None:
        ...
        """
        browser_driver.get(URL)
        carousel_1 = helper.get_element_by_id(browser_driver, LATEST_OPENED_DASHBOARDS_ID)
        carousel_2 = helper.get_element_by_id(browser_driver, SHARED_DASHBOARDS_ID)
