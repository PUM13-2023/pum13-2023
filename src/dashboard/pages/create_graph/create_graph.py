        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Label("Choose color for graph 1 "),
                    dbc.Input(
                        type="color",
                        id="color_input",
                        value="#0000FF",
...
def main(
    ...
    if download_png:
        fig.write_image("graph_images/" + file_name + ".png", width=1920, height=1080)
    if download_jpeg:
    ...
    loc_graph = dcc.Graph(figure=fig, config=loc_config)
    return loc_graph
